...
ALLOWED_HOSTS = ["localhost", 
                ...
                #  "https://douganddeb3-8000.theiadocker-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai",
]
...
# CSRF_TRUSTED_ORIGINS = ['dnel.mybluemix.net', 'dnel.mybluemix.net/static', 'https://douganddeb3-8000.theiadocker-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/','localhost' ]
